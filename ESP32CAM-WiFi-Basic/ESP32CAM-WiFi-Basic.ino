 ...
 * Fecha_Modificacion: 29 de julio de 2021
 * En la modificacion se usa el pin 13 como salida para alimentar un LED externo a la tarjeta
 * componente               PinESP32      Estados logicos      
 * Diodo LED................GPIO 13 ......On => HIGH, off => LOW
 * Resistencia 220 ohm
 *-----------------------------------------------------------------------------------------------
 *-----------------------------------------------------------------------------------------------
 */
...
// Datos de Red
const char* ssid = "TP-Link_A412";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "_L4gun3z";  // Escribe la contraseña de dicha red
...
int ledPrueba = 13;  // pin para el LED
